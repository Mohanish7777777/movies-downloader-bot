...
url_list = {}
api_key = "ef421b11a0642c88b76a2edf760e30cedf10f72c"


def search_movies(query):
    movies_list = []
    movies_details = {}
    website = BeautifulSoup(requests.get(f"https://kaipullax.kfakeid9.workers.dev/0:search?q={query.replace(' ', '+')}").text, "html.parser")
